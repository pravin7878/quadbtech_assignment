const Footer = () => {
    ...
    return (
        <footer className="text-gray-500 bg-white border px-4 max-w-screen-xl mx-auto md:px-8">
            
            <div className=" items-center justify-between sm:flex">
                <div className="py-2 sm:mt-0">
                    &copy; 2025 DoIt App All rights reserved.
                </div>
                <div className="hidden md:block sm:mt-0 py-1">
